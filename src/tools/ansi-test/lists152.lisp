...
(my-assert
 (nconc (list 1 2)
	'a)
 #+xcl error
 #+(or clisp akcl allegro cmu sbcl) (1 2 . a)
 #-(or xcl clisp akcl allegro cmu sbcl) unknown)

(my-assert
 (nconc 'a)
 #+xcl error
 #+(or clisp akcl allegro cmu sbcl) a
 #-(or xcl clisp akcl allegro cmu sbcl) unknown)
...
(my-assert
 ...
 #+clisp (c b a d e f)
 #+(or akcl allegro cmu sbcl) (a d e f)
 #-(or xcl clisp akcl allegro cmu sbcl) unknown)
...
(my-assert
 (nconc nil 'x)
 #+xcl error
 #+(or clisp akcl allegro cmu sbcl) x
 #-(or xcl clisp akcl allegro cmu sbcl) unknown)
