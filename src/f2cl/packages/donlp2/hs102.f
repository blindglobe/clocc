...
C   HS102
     ...
     3          2.D0,2.D0,-1.D0,.5D0,-2.D0,1.D0/
      ...
      INCLUDE 'O8FUCO.INC'
      DOUBLE PRECISION X(NX),GRADF(NX),DL(NX),ALF(6,4),GAMF(4)
      INTEGER KF(6,4)
      SAVE KF,ALF,GAMF
      DATA KF/1,2,4,6,7,0,1,2,3,4,5,7,1,2,4,5,6,0,1,2,3,5,6,7/
      DATA GAMF/10.D0,15.D0,20.D0,25.D0/
     ...
     3          2.D0,2.D0,-1.D0,.5D0,-2.D0,1.D0/
      ...
      DOUBLE PRECISION X(NX),DL(NX),ALF(6,4),GAMF(4),
...
C****************************************************************
      ...
      IMPLICIT NONE
      DOUBLE PRECISION GAM(NANZ),AL(NLEN,NANZ),X(NX),DL(NX),CON,FX
      INTEGER K(NLEN,NANZ),NLEN,NANZ,NX
      LOGICAL LIN
...
C        FOR FUNCTION DEFINITON SEE FGEO ABOVE
      IMPLICIT NONE
