...
(my-assert
 (multiple-value-list (lisp:xgcd 77874422 32223899))
 (1 -9206830 22249839))

(my-assert
 (multiple-value-list (lisp:xgcd 560014183 312839871))
 (1 77165803 -138134388))

(my-assert
 (multiple-value-list (lisp:xgcd 3 2))
 (1 1 -1))

(my-assert
 (multiple-value-list (lisp:xgcd 2 3))
 (1 -1 1))
...
(my-assert
 (let ((a 974507656412513757857315037382926980395082974811562770185617915360)
   ...
   (multiple-value-bind (g u v) (lisp:xgcd a b)
