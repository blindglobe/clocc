...
(my-assert
 ...
 #+(or allegro cmu sbcl sbcl)
 (&optional &rest &key &aux &body &whole &allow-other-keys &environment)
 #-(or xcl clisp akcl allegro cmu sbcl sbcl) unknown)
...
(my-assert
 (consp (acons 'x 'y 'a))
 #+xcl error
 #+(or clisp akcl allegro cmu sbcl sbcl) t
 #-(or xcl clisp akcl allegro cmu sbcl sbcl) unknown)
...
(my-assert
 ...
 #+(or cmu sbcl sbcl) nil
 #-(or xcl clisp allegro cmu sbcl sbcl) unknown)
...
(my-assert
 ...
 #+(or allegro cmu sbcl sbcl) "-4.898425415289509d-16"
 #-(or xcl clisp akcl allegro cmu sbcl sbcl) unknown)
...
(my-assert
 ...
 #+(or allegro cmu sbcl sbcl) "6.123031769111886d-17"
 #-(or xcl clisp akcl allegro cmu sbcl sbcl) unknown)
...
(my-assert
 (atan 1)
 #+(or xcl allegro cmu sbcl sbcl) 0.7853982
 #+clisp 0.7853981
 #-(or xcl allegro clisp cmu sbcl sbcl) unknown)

(my-assert
 (prin1-to-string pi )
 #+xcl "3.141592653589793D0"
 #+clisp "3.1415926535897932385L0"
 #+(or allegro cmu sbcl sbcl) "3.141592653589793d0"
 #-(or xcl clisp allegro cmu sbcl sbcl) unknown)
...
(my-assert
 (let ((s (prin1-to-string most-negative-fixnum )))
   (or #+(or xcl clisp) (equal s "-16777216")
       ...
       #+clisp (equal s "-4294967296")
       #+(or allegro cmu sbcl sbcl) (equal s "-536870912")
       ) )
 t)
...
(my-assert
 ...
 #+(or cmu sbcl sbcll) "4.940656458412465d-324"
 #-(or xcl clisp allegro cmu sbcl sbcl) unknown)
...
(my-assert
 char-code-limit
 #+xcl 128
 #+(or (and clisp (not unicode)) akcl sbcl cmu) 256
...
(my-assert
 ...
 #+(or clisp cmu sbcl sbcl  lucid) (i (uu) uu) ; x ein blatt, y aus der aliste
 #-(or xcl clisp cmu sbcl sbcl  lucid allegro) unknown)
...
(my-assert
 ...
 #+xcl (a b c d u i)
 #+clisp (c d u i b a)
 #+(or allegro cmu sbcl sbcl) (d c u i b a)
 #-(or xcl clisp allegro cmu sbcl sbcl) unknown)
...
(my-assert
 ...
 #+xcl (v i a b c d)
 #+clisp (b c a d i v)
 #+(or allegro cmu sbcl sbcl) (c b a d i v)
 #-(or xcl clisp allegro cmu sbcl sbcl) unknown)
...
(my-assert
 (set-exclusive-or (list 'anton 'anna 'emil)
		   ...
		   :test (lambda (x y)
			   (eql (elt (symbol-name x) 0)
				(elt (symbol-name y) 0))))
 #-(or allegro cmu sbcl sbcl) (emil berta)
 #+(or allegro cmu sbcl sbcl) (berta emil))
